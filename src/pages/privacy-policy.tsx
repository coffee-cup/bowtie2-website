...
const PrivacyPolicy: NextPage = () => {
  return (
    <Page seo={{ title: "Privacy Policy" }}>
      <h1 className="my-12">Privacy Policy</h1>

      <div className="prose">
        <p>
          Jake Runzer built the Bowtie app as a Free app. This SERVICE is
          provided by Jake Runzer at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at Bowtie unless otherwise
